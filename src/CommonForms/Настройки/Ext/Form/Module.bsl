...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)	
	...
	Элементы.ВерсияПриложения.Заголовок = "Версия приложения: " + Константы.ВерсияПриложения.Получить();
КонецПроцедуры
...
Процедура СправкаАПИ(Команда)
	ФC1 = Новый ФорматированнаяСтрока("Данный токен нужен для автоматического заполнения данных о фильмах.");
	ФC2 = Новый ФорматированнаяСтрока("Для получения токена зарегистрируйтесь на сайте kinopoiskapiunofficial.tech.");
	ФC3 = Новый ФорматированнаяСтрока("Перейти на сайт",,,,"https://kinopoiskapiunofficial.tech");	
	Массив = Новый Массив;
	Массив.Добавить(ФC1);
