...
Процедура ПриОткрытии(Отказ)
	...
	#Если ТонкийКлиент или ВебКлиент Тогда
		Элементы.Статистика.Видимость = Истина;
		Элементы.Настройки.Видимость = Истина;
		Элементы.КнСтатистика.Видимость = Ложь;
		Элементы.КнНастройки.Видимость = Ложь;
	#КонецЕсли
КонецПроцедуры
...
&НаКлиенте
Процедура ЖанрыНажатие(Команда)
	ОткрытьФорму("Справочник.Жанры.ФормаСписка");
КонецПроцедуры

&НаКлиенте
Процедура СтраныНажатие(Команда)
	ОткрытьФорму("Справочник.Страны.ФормаСписка");
КонецПроцедуры

&НаКлиенте
Процедура НастройкиНажатие(Команда)
...
&НаКлиенте
Асинх Процедура ВопросУдалить(Ссылка)	
	Результат = Ждать ВопросАсинх(Нстр("ru = 'Удалить ""'; en = 'Delete ""'") + Строка(Ссылка) + """?",РежимДиалогаВопрос.ДаНет,,,Нстр("ru = 'Удаление'; en = 'Removal'"));	
...
Процедура Статистика(Команда)
	ОткрытьФорму("Отчет.СтатистикаПросмотров.Форма");
КонецПроцедуры
